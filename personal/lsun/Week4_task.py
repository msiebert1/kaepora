...
rootdir = '/Users/fripsun/astr596/data/cfa/' # directory where data is
...
res_comp_data2 = comp_data2-comp_data2
res_hi_data2 = hi_data2-comp_data2
res_lo_data2 = lo_data2-comp_data2
...
plt.plot(x_val2, res_comp_data2, label = "Composite")
plt.plot(x_val2, res_hi_data2, label = "Composite Hi")
plt.plot(x_val2, res_lo_data2, label = "Composite Lo")
plt.plot(x_val2, rms_data2, label = "+ RMS")
plt.plot(x_val2, -rms_data2, label = "- RMS")
plt.legend()


plt.subplots_adjust(hspace=0.7)
plt.savefig(link + 'Na_EW spectra.png')
