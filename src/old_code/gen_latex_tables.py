...
if __name__ == "__main__":
	...
	table_1 = tabulate(tab_arr, headers=['SN Name', 'MJD', 'Phase', 'S/N', 'Wavelength Range', 'Reference'], tablefmt = 'ascii', floatfmt=".1f")
	...
	write_ascii_table('table_1_updated.txt', table_1, caption)
	raise TypeError
