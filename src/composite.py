...
while (i==0):
    low_overlap = []
    for SN in SN_Array:
        SN, min_wave, max_wave= cut(composite, SN, SN_Array, min_wave, max_wave)
    #low_overlap, SN_Array = overlap(composite, SN_Array)
    for SN in SN_Array:
        SN = scale(composite, SN, lowindex, highindex)
